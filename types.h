...
#define LOG_FORMAT_MACRO_COUNT 11
char* VALID_MACROS[LOG_FORMAT_MACRO_COUNT] =
	{ LOG_YEAR_MACRO, LOG_MONTH_MACRO, LOG_DAY_MACRO, LOG_HOUR_MACRO,
	LOG_MINUTE_MACRO, LOG_SEC_MACRO, LOG_DOW_3_MACRO, LOG_DOW_FULL_MACRO,
	LOG_LEVEL_MACRO, LOG_MSG_MACRO, LOG_MACRO_BEGIN_ESC };
