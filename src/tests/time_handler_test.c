...
#define _YEAR_MAX_CHARS 4
#define _MNAME_MAX_CHARS 9
#define _WDAY_MAX_CHARS 9
...
void test_get_mname_s(int tm_mon, _MNAME_FORMAT format,
    char* correct_result)
{
    t->_ltime->tm_mon = tm_mon;
    char result[_MNAME_MAX_CHARS];
...
void test_get_mname(void)
{
    ...
    test_get_mname_s(0, _MN_SHORT_FIRST_CAP, "Jan");
    test_get_mname_s(0, _MN_SHORT_ALL_CAPS, "JAN");
    test_get_mname_s(0, _MN_LONG_FIRST_CAP, "January");
    test_get_mname_s(0, _MN_LONG_ALL_CAPS, "JANUARY");

    test_get_mname_s(7, _MN_SHORT_FIRST_CAP, "Aug");
    test_get_mname_s(7, _MN_SHORT_ALL_CAPS, "AUG");
    test_get_mname_s(7, _MN_LONG_FIRST_CAP, "August");
    test_get_mname_s(7, _MN_LONG_ALL_CAPS, "AUGUST");

    test_get_mname_s(11, _MN_SHORT_FIRST_CAP, "Dec");
    test_get_mname_s(11, _MN_SHORT_ALL_CAPS, "DEC");
    test_get_mname_s(11, _MN_LONG_FIRST_CAP, "December");
    test_get_mname_s(11, _MN_LONG_ALL_CAPS, "DECEMBER");

    printf(" -> OK\n");
}

void test_get_wday_single_pass(int tm_wday, _WDAY_FORMAT format,
    char* correct_result)
{
    t->_ltime->tm_wday = tm_wday;
    char result[_WDAY_MAX_CHARS];
...
void test_get_wday(void)
{
    ...
    test_get_wday_single_pass(0, _WD_SHORT_FIRST_CAP, "Sun");
    test_get_wday_single_pass(0, _WD_SHORT_ALL_CAPS, "SUN");
    test_get_wday_single_pass(0, _WD_LONG_FIRST_CAP, "Sunday");
    test_get_wday_single_pass(0, _WD_LONG_ALL_CAPS, "SUNDAY");

    test_get_wday_single_pass(1, _WD_SHORT_FIRST_CAP, "Mon");
    test_get_wday_single_pass(1, _WD_SHORT_ALL_CAPS, "MON");
    test_get_wday_single_pass(1, _WD_LONG_FIRST_CAP, "Monday");
    test_get_wday_single_pass(1, _WD_LONG_ALL_CAPS, "MONDAY");

    test_get_wday_single_pass(6, _WD_SHORT_FIRST_CAP, "Sat");
    test_get_wday_single_pass(6, _WD_SHORT_ALL_CAPS, "SAT");
    test_get_wday_single_pass(6, _WD_LONG_FIRST_CAP, "Saturday");
    test_get_wday_single_pass(6, _WD_LONG_ALL_CAPS, "SATURDAY");
