...
void run_perftest(char* e_format, char* msg, time_t duration)
{
    ...
    log_set_entry_format(log, LG_TRACE, e_format);
    log_set_entry_format(log, LG_DEBUG, e_format);
    log_set_entry_format(log, LG_INFO, e_format);
    log_set_entry_format(log, LG_NOTICE, e_format);
    log_set_entry_format(log, LG_WARNING, e_format);
    log_set_entry_format(log, LG_ERROR, e_format);
    log_set_entry_format(log, LG_CRITICAL, e_format);
    log_set_entry_format(log, LG_ALERT, e_format);
    log_set_entry_format(log, LG_EMERGENCY , e_format);
