...
typedef enum { _WD_SHORT_FIRST_CAP, _WD_SHORT_ALL_CAPS,
    _WD_LONG_FIRST_CAP, _WD_LONG_ALL_CAPS } _WDAY_FORMAT;

/* Determines whether thandler_get_mname gets the month name as
jan, Jan, JAN, january, January or JANUARY. */
typedef enum { _MN_SHORT_FIRST_CAP, _MN_SHORT_ALL_CAPS,
    _MN_LONG_FIRST_CAP, _MN_LONG_ALL_CAPS} _MNAME_FORMAT;
...
void th_get_hour(thandler_t* th, char* hours);

void th_get_min(thandler_t* th, char* mins);

void th_get_sec(thandler_t* th, char* secs);

void th_get_mname(thandler_t* th, char* mname, _MNAME_FORMAT format);

void th_get_wday(thandler_t* th, char* wday, _WDAY_FORMAT format);
